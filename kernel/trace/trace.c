...
static unsigned long        trace_buf_size_cpu0 = 6291456UL;
static unsigned long        trace_buf_size_cpuX = 5242880UL;
#endif
...
=======
>>>>>>> bf09db97205d... tracing: Remove ftrace_stop/start() from reading the trace file
	raw_spin_lock_irqsave(&tracing_start_lock, flags);
	if (trace_stop_count++)
		goto out;
...
>>>>>>> 7b7cf9fa6d34... tracing: Prevent buffer overwrite disabled for latency tracers
{
